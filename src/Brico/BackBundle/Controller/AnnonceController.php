...
use Brico\BackBundle\Form\AnnonceType;
...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $annonces = $em->getRepository('BricoBackBundle:Annonce')->findAll();
    ...
    {
        $annonce = new Annonce();
        $form = $this->createForm('Brico\BackBundle\Form\AnnonceType', $annonce);
    ...
    {
        $deleteForm = $this->createDeleteForm($annonce);
        $editForm = $this->createForm('Brico\BackBundle\Form\AnnonceType', $annonce);
